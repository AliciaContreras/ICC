...
SECRET_KEY = 'django-insecure-p!s4@*b8x!ufht1i+7p273nkwd02@1-ptvp8vq2un9jp2!j7fk'
...
DATABASES = {
    'default': dj_database_url.config(
        # ¡Pega aquí tu URL local completa!
        default='postgres://postgres:root@localhost:5432/iqs_db',
        conn_max_age=600
    )
}
